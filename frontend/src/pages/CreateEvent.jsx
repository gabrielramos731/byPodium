...
function CreateEvent() {
  ...
  const [categoriaMinError, setCategoriaMinError] = useState(false);
  ...
  const validateForm = () => {
    ...
    if (!formData.data_inicio_inscricao) {
      newErrors.data_inicio_inscricao =
        "Data de início das inscrições é obrigatória";
    }
    ...
    if (
      formData.data_inicio_inscricao &&
      formData.data_fim_inscricao &&
      formData.data_inicio_inscricao > formData.data_fim_inscricao
    ) {
      newErrors.data_fim_inscricao =
        "Data de fim das inscrições deve ser posterior à data de início das inscrições";
    }

    if (
      formData.data_fim_inscricao &&
      formData.data_inicio &&
      formData.data_fim_inscricao > formData.data_inicio
    ) {
      newErrors.data_fim_inscricao =
        "Data de fim das inscrições deve ser anterior ou igual à data do evento";
    }
    ...
    if (categorias.length === 0) {
      ...
      if (categoriasValidas.length === 0) {
        newErrors.categorias =
          "Pelo menos uma categoria deve estar completamente preenchida";
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (categorias.length > 0) {
        eventData.categorias = categorias
          .filter(
            (cat) =>
              cat.nome && cat.sexo && cat.idadeMin !== "" && cat.idadeMax !== ""
          )
      ...
      if (kits.length > 0) {
        eventData.kits = kits
          .filter((kit) => kit.nome && kit.precoExtra !== "")
          .map((kit) => ({
            nome: kit.nome,
          ...
          >
            <div className={styles.section}>
              ...
              <div className={styles.inputGroup}>
                ...
                />
                {errors.imagem && (
                  <span className={styles.errorMessage}>{errors.imagem}</span>
                )}
              </div>
            </div>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.row}>
                <div className={styles.inputGroup}>
                  <label htmlFor="data_inicio" className={styles.label}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`${styles.input} ${
                      errors.data_inicio ? styles.inputError : ""
                    }`}
                  />
                  {errors.data_inicio && (
                    <span className={styles.errorMessage}>
                ...
                <div className={styles.inputGroup}>
                  <label htmlFor="data_fim" className={styles.label}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`${styles.input} ${
                      errors.data_fim ? styles.inputError : ""
                    }`}
                  />
                  {errors.data_fim && (
                    <span className={styles.errorMessage}>
              ...
              <div className={styles.row}>
                <div className={styles.inputGroup}>
                  <label htmlFor="horario_inicio" className={styles.label}>
                ...
                <div className={styles.row}>
                  <div className={styles.inputGroup}>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`${styles.input} ${
                        errors.data_inicio_inscricao ? styles.inputError : ""
                      }`}
                    />
                    {errors.data_inicio_inscricao && (
                      <span className={styles.errorMessage}>
                        {errors.data_inicio_inscricao}
                      </span>
                    )}
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`${styles.input} ${
                        errors.data_fim_inscricao ? styles.inputError : ""
                      }`}
                    />
                    {errors.data_fim_inscricao && (
                      <span className={styles.errorMessage}>
                        {errors.data_fim_inscricao}
                      </span>
                    )}
            ...
            <div className={styles.section}>
              ...
              <div className={styles.row}>
                <div className={styles.inputGroup}>
                  ...
                  {errors.uf && (
                    <span className={styles.errorMessage}>{errors.uf}</span>
                  )}
                </div>
                ...
                <div className={styles.inputGroup}>
                  ...
                  {errors.cidade && (
                    <span className={styles.errorMessage}>{errors.cidade}</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.row}>
                <div className={styles.inputGroup}>
                  <label htmlFor="valor_inscricao" className={styles.label}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`${styles.input} ${
                      errors.valor_inscricao ? styles.inputError : ""
                    }`}
                    placeholder="0.00"
                  />
                  {errors.valor_inscricao && (
                    <span className={styles.errorMessage}>
                      {errors.valor_inscricao}
                    </span>
                  )}
                ...
                <div className={styles.inputGroup}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`${styles.input} ${
                      errors.limite_participantes ? styles.inputError : ""
                    }`}
                    placeholder="100"
                  />
            ...
            <div className={styles.section}>
              ...
              <p className={styles.sectionDescription}>
                ...
                {categoriaMinError && (
                <span className={styles.errorMessage}>Deve existir ao menos uma categoria.</span>
              )}
              {errors.categorias && (
                <span className={styles.errorMessage}>{errors.categorias}</span>
              )}
                  ...
                  <div className={styles.row}>
                    <div className={styles.inputGroup}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCategoria(index, "nome", e.target.value)
                        }
                        className={styles.input}
                    ...
                    <div className={styles.inputGroup}>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateCategoria(index, "sexo", e.target.value)
                        }
                        className={styles.select}
                      >
                  ...
                  <div className={styles.row}>
                    <div className={styles.inputGroup}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCategoria(index, "idadeMin", e.target.value)
                        }
                        className={styles.input}
                        placeholder="16"
                      />
                    ...
                    <div className={styles.inputGroup}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCategoria(index, "idadeMax", e.target.value)
                        }
                        className={styles.input}
                        placeholder="18"
                      />
                  ...
                  <div className={styles.row}>
                    <div className={styles.inputGroup}>
                      ...
                      <input
                        ...
                        value={kit.nome}
                        onChange={(e) =>
                          updateKit(kitIndex, "nome", e.target.value)
                        }
                        className={styles.input}
                    ...
                    <div className={styles.inputGroup}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateKit(kitIndex, "precoExtra", e.target.value)
                        }
                        className={styles.input}
                        placeholder="25.00"
                      />
